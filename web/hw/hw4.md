...
This assignment uses the Cerebras SDK. We have placed a version of the SDK on Perlmutter, available at `/global/cfs/cdirs/m4341/cs6230/cbsdk-1.3.0`. To setup and install the SDK, first run:
```
student@perlmutter: ~/hw4/global/cfs/cdirs/m4341/cs6230/cbsdk-1.3.0/install.sh
```
then add the SDK to your path:
```
student@perlmutter: export PATH=$PATH:/global/cfs/cdirs/m4341/cs6230/cbsdk-1.3.0
```
