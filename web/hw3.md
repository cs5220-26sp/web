...
This assignment is an introduction to parallel programming using a distributed memory model. Most of this page will be similar to the HW2 and HW3 page.
...
![particles-1.gif](../figures/particles-1.gif)
